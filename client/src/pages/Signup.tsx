  ...
  return (
    <div className="w-screen h-screen flex flex-row items-center justify-center">
      <div className="w-1/2 h-full bg-white flex flex-row justify-end items-center">
        <div className="w-[90%] h-[80%] rounded-tl-4xl rounded-bl-4xl bg-black flex flex-col items-center justify-center gap-10 text-4xl text-white">
          ...
          <button
            ...
            className="w-[60%] h-[12%] bg-white text-black font-bold rounded-xl hover:bg-opacity-90 transition"
          >
            Sign in
          </button>
        </div>
      ...
      <div className="w-1/2 h-full bg-black flex flex-row justify-start items-center">
        <form
          ...
          className="w-[90%] h-[80%] rounded-tr-4xl rounded-br-4xl bg-white flex flex-col items-center justify-center gap-8"
        >
